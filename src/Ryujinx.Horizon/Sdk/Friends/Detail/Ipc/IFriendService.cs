...
namespace Ryujinx.Horizon.Sdk.Friends.Detail.Ipc
{
    interface IFriendService : IServiceObject
    {
        ...
        Result GetFriendDetailedInfoV2(out FriendDetailedInfoImpl detailedInfo, Uid userId, NetworkServiceAccountId friendId);
        Result SyncFriendList(Uid userId);
        Result RequestSyncFriendList(Uid userId);
        Result GetFriendListForViewer(out int count, Span<FriendForViewerImpl> friendList, Uid userId, int offset, SizedFriendFilter filter);
        Result UpdateFriendInfoForViewer(Span<FriendForViewerImpl> info, Uid userId, ReadOnlySpan<NetworkServiceAccountId> friendIds);
        Result GetFriendListForViewerV2(out int count, Span<byte> friendList, Uid userId, int offset, SizedFriendFilter filter);
        Result UpdateFriendInfoForViewerV2(Span<byte> info, Uid userId, ReadOnlySpan<NetworkServiceAccountId> friendIds);
        Result LoadFriendSetting(out FriendSettingImpl friendSetting, Uid userId, NetworkServiceAccountId friendId);
        Result LoadFriendSettingV2(out FriendSettingImplV2 friendSetting, Uid userId, NetworkServiceAccountId friendId);
        ...
        Result GetFriendRequestListV2(out int count, Span<FriendRequestImplV2> requestList, Uid userId, int arg3, int arg4);
        Result GetReceivedFriendRequestPushCount(out int count, Uid userId);
        ...
        Result GetBlockedUserListV2(out int count, Span<BlockedUserImplV2> blockedUsers, Uid userId, int offset);
        ...
        Result GetProfileExtraListV2(Span<ProfileExtraImplV2> extraList, Uid userId, ReadOnlySpan<NetworkServiceAccountId> friendIds);
        ...
        Result LoadUserSettingV2(out UserSettingImplV2 userSetting, Uid userId);
        ...
        Result GetReceivedFriendInvitationListV2(out int count, Span<FriendInvitationForViewerImplV2> invitationList, Uid userId);
        Result GetReceivedFriendInvitationDetailedInfo(out FriendInvitationGroupImpl invitationGroup, Uid userId, FriendInvitationGroupId groupId);
        Result GetReceivedFriendInvitationDetailedInfoV2(out FriendInvitationGroupImplV2 invitationGroup, Uid userId, FriendInvitationGroupId groupId);
        ...
        Result ChangeFriendNote(Uid userId, NetworkServiceAccountId friendId, FriendNote note);
        Result SendPendingFriendChange(Uid userId, NetworkServiceAccountId friendId);
        Result SendPendingFriendChangeUnchecked(Uid userId, NetworkServiceAccountId friendId);
        ...
        Result SendFriendRequestWithApplicationInfoV2(Uid userId, NetworkServiceAccountId friendId, int channel, ApplicationInfoV2 applicationInfo, in InAppScreenName arg4, in InAppScreenName arg5);
        ...
        Result SendFriendInvitationV2(Uid userId, ReadOnlySpan<NetworkServiceAccountId> friendIds, in FriendInvitationGameModeDescription description, ApplicationInfoV2 applicationInfo, ReadOnlySpan<byte> applicationData, bool applicationIdMatch);
